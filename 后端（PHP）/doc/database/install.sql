...
CREATE TABLE `yoshop_dealer_capital` (
  ...
  `number` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'is_status等于1时为金额，2时为积分',
  `describe` varchar(500) NOT NULL DEFAULT '' COMMENT '描述',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  `is_status`  tinyint(3) NOT NULL DEFAULT 0 COMMENT '1时为金额，2时为积分',
  PRIMARY KEY (`id`)
...
INSERT INTO `yoshop_store_access` VALUES ('10370', '满额包邮', 'market.basic/full_free', '10052', '120', '1551505016', '1551505016');
